...
<body>
		...
		<div class="pt-4 col-4">
			...
			<div class="d-flex justify-content-between">
				...
				<a href="/contactUs"
					...
					href="/logout" class="headerAnchor link-dark text-decoration-none">Logout</a>
			</div>
		</div>
	</header>
	...
	<main class="d-flex">
		<div
			style="height: auto: 
				width:23%; min-width: 300px; padding-left: 40px;">
			<div class="d-flex">
		...
		<div
			style="height: 500px; width: 100%; min-width: 650px; margin-right: 30px;">
			<h4 class="text-center mb-3">
				My Catalog <a href="/doggies/new"
					style="margin-left: 5px; text-decoration: none; font-size: 15px;">(
					add )</a>
			</h4>
			<div
				style="height: 300px; min-width: 650px; border-style: solid; border-radius: 10px; border-color: #DCDCDC; padding: 0 10px; overflow: scroll;">
						...
						<tbody>
							<c:if test="${oneDog.user.id == userId}">
								...
								<td><img style="height: 50px;"
									src="${pageContext.request.contextPath}/profile/${oneDog.content}"></td>
