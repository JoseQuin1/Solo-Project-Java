...
<body>
	...
	<main class="mx-auto col-6">
		<form:form action="/teams/${team.id}/edit" method="put" modelAttribute="team">
			<div class="pb-3">
			...
			<div class="pb-3">
				...
				<form:select path="gameDay">
					<option value="${team.gameDay}">${team.gameDay}</option>
		...
		<div class="my-5"><a href="/teams/${team.id}/delete">delete</a></div>
	</main>
</body>
</html>